...
bool rm_server__srv__el_gamal_encrypt__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // y1
    ...
    assert(PyLong_Check(field));
    ros_message->y1 = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // y2
    ...
    assert(PyLong_Check(field));
    ros_message->y2 = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
...
PyObject * rm_server__srv__el_gamal_encrypt__response__convert_to_py(void * raw_ros_message)
{
  ...
  {  // y1
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->y1);
    {
  ...
  {  // y2
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->y2);
    {
