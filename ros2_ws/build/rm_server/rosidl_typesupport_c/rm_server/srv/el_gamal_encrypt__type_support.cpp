...
#include "rm_server/srv/detail/el_gamal_encrypt__type_support.h"
...
static const _ElGamalEncrypt_Request_type_support_symbol_names_t _ElGamalEncrypt_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_server, srv, ElGamalEncrypt_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rm_server, srv, ElGamalEncrypt_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rm_server, srv, ElGamalEncrypt_Request)() {
  return &::rm_server::srv::rosidl_typesupport_c::ElGamalEncrypt_Request_message_type_support_handle;
}
...
static const _ElGamalEncrypt_Response_type_support_symbol_names_t _ElGamalEncrypt_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_server, srv, ElGamalEncrypt_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rm_server, srv, ElGamalEncrypt_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rm_server, srv, ElGamalEncrypt_Response)() {
  return &::rm_server::srv::rosidl_typesupport_c::ElGamalEncrypt_Response_message_type_support_handle;
}
...
static const _ElGamalEncrypt_type_support_symbol_names_t _ElGamalEncrypt_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_server, srv, ElGamalEncrypt)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rm_server, srv, ElGamalEncrypt)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rm_server, srv, ElGamalEncrypt)() {
  return &::rm_server::srv::rosidl_typesupport_c::ElGamalEncrypt_service_type_support_handle;
}
